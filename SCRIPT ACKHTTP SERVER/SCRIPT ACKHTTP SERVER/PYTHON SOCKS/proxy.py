...
import socket, threading, thread, select, signal, sys, getopt
...
class Server(threading.Thread):
    ...
    def run(self):
        ...
        self.soc.setsockopt(socket.SOL_SOCKET, socket.SO_REUSEPORT, 2)
        self.soc.settimeout(30000)
